...
-- 1. AI융합학부 콜로퀴움(7차)
('prg_1764851294875', '[특성화학과] AI융합학부 콜로퀴움(7차)', '[특성화학과] AI융합학부 콜로퀴움(7차)',
 'prg_3', 'AI융합학부', '비대면',
 '2025-12-04 00:00:00', '2025-12-11 23:59:00', '2025-12-12 12:00:00', '2025-12-12 14:00:00',
 '온라인 ZOOM', '숭실대학교 학생(재학, 휴학, 수료)', 100,
 '2025학년도 AI융합학부 콜로퀴움(7차)를 안내합니다. 학생들의 많은 관심과 참여 바랍니다. 1. 일시 : 2025.12.12(금) 12:00 2. 장소 : 온라인 ZOOM(https://ssu-ac-kr.zoom.us/my/ssuaix)  * 참여자 확인을 위해 줌링크 접속시 학번-이름으로 변경 3. 강사 : 박재식 교수(서울대학교 컴퓨터공학부) 4. 주제 : AI 기술 동향: 시각 지능 분야 5. 신청 : 12.11(목)까지 슈패스(SSU-PATH)', 'https://path.ssu.ac.kr/ptfol/imng/icmpNsbjtPgm/findIcmpNsbjtPgmInfo.do?encSddpbSeq=0f54a6f2f29e5b468142836739bfd6f4', NOW()),

-- 2. AI융합학부 콜로퀴움(6차)
('prg_1764851302813', '[특성화학과] AI융합학부 콜로퀴움(6차)', '[특성화학과] AI융합학부 콜로퀴움(6차)',
 'prg_3', 'AI융합학부', '비대면',
 '2025-12-04 00:00:00', '2025-12-09 23:59:00', '2025-12-10 12:00:00', '2025-12-10 14:00:00',
 '온라인 ZOOM(https://ssu-ac-kr.zoom.us/my/ssuaix)', '숭실대학교 학생 (재학, 휴학, 수료)', 100,
 '콜로퀴움을 통해 현 업계의 동향을 파악하고, 관련 분야의 지식 및 취업 정보 등을 제공하고자 한다. 현업에 종사중인 전문가를 초청하여 관련 분야의 지식과 함께 현 업계의 동향을 파악하고 취업에 관련된 정보를 제공하고자 하는 프로그램입니다.', 'https://path.ssu.ac.kr/ptfol/imng/icmpNsbjtPgm/findIcmpNsbjtPgmInfo.do?encSddpbSeq=fe67d9f4e3715b71b018f92d6349bb27', NOW()),

-- 3. 새빛독서캠프
('prg_1764851309937', '새빛독서캠프', '숭실대학교 중앙도서관 독서캠프',
 'prg_16', '중앙도서관', '대면',
 '2025-12-03 00:00:00', '2025-12-18 23:59:00', '2026-01-15 00:00:00', '2026-01-16 00:00:00',
 '서해마루 유스호스텔(경기도 화성시 소재)', '숭실대학교 재학생 및 휴학생', 32,
 '독서캠프는 책 읽을 시간이 없는 학생들에게 1박 2일 동안 독서에 집중할 수 있는 시간을 제공하는 프로그램입니다.', 'https://path.ssu.ac.kr/ptfol/imng/icmpNsbjtPgm/findIcmpNsbjtPgmInfo.do?encSddpbSeq=10d2e3a9208ee0e31dab9ba2fddcd945', NOW()),

-- 4. 2026 신입생 예비대학 접수(인문대학)
('prg_1764851318912', '2026 신입생 예비대학 접수(인문대학)', '2026 신입생 예비대학 접수(인문대학)',
 'prg_12', '교양교육운영팀', '대면',
 '2025-12-03 00:00:00', '2025-12-26 23:59:00', '2026-01-14 10:30:00', '2026-01-16 13:50:00',
 NULL, '숭실대학교 일반인', 50,
 '신입생 예비대학 프로그램은 교과 과정과 함께 메타버스 및 멘토링 프로그램을 융합한 프로그램으로 신입생의 대학생활 적응을 지원하는 프로그램입니다. 신입생 예비대학은 수시 입학생 신입생을 대상으로 진행하는 학사 제도 안내 및 학과(부)별 선후배 멘토링 프로그램입니다.', 'https://path.ssu.ac.kr/ptfol/imng/icmpNsbjtPgm/findIcmpNsbjtPgmInfo.do?encSddpbSeq=0beacc39f5e7a221bca8e732badf4233', NOW()),

-- 5. 숭실대학교 학생기자단 프레슈 16기
('prg_1764851331572', '숭실대학교 학생기자단 프레슈 16기', '숭실대학교 학생기자단 프레슈 16기',
 'prg_8', '홍보팀', '대면',
 '2025-12-04 09:00:00', '2025-12-15 23:59:00', '2026-02-01 00:00:00', '2027-01-31 00:00:00',
 NULL, '숭실대학교 학생', 15,
 '숭실대학교 학생기자단 프레슈(PRESSU)는 대외협력실 홍보팀 소속으로, SNS 관리, 홍보 콘텐츠(영상/카드뉴스/인터뷰) 제작, 학교 행사 취재(기사)등의 활동을 수행합니다.', 'https://path.ssu.ac.kr/ptfol/imng/icmpNsbjtPgm/findIcmpNsbjtPgmInfo.do?encSddpbSeq=7649d2029ce1e4d81444f11746470e97', NOW()),

-- 6. 프로그래밍 중급(생성형AI와 AI에이전트 개발 교육)
('prg_1764851339161', '프로그래밍 중급(생성형AI와 AI에이전트 개발 교육)', '프로그래밍 중급(생성형AI와 AI에이전트 개발 교육)',
 'prg_12', '공학교육혁신팀', '대면',
 '2025-12-02 00:00:00', '2025-12-24 10:00:00', '2025-12-29 10:00:00', '2025-12-31 17:00:00',
 '형남공학관 B109호(창의공학설계실)', '공과대학, IT대학, 자연과학대학의 재학, 휴학, 수료 학생', 25,
 '프로그래밍 언어인 파이썬의 기초 문법을 이해하고 20함수, 데이터 분석과 수집을 위한 스크래핑 방법을 학습하는 프로그램입니다.', 'https://path.ssu.ac.kr/ptfol/imng/icmpNsbjtPgm/findIcmpNsbjtPgmInfo.do?encSddpbSeq=f479e610b804e0be23c458c52f98cbaf', NOW()),

-- 7. 2025학년도 27주년 평생교육학과의 날
('prg_1764851346697', '2025학년도 27주년 평생교육학과의 날', '2025학년도 27주년 평생교육학과의 날',
 'prg_3', '평생교육학과', '대면',
 '2025-12-02 00:00:00', '2025-12-07 00:00:00', '2025-12-03 00:00:00', '2025-12-10 00:00:00',
 NULL, '평생교육학과 학생', 50,
 '교수, 학부생 및 대학원생, 학부와 석박사 동문들이 한 자리에 모여 평생교육학과의 날을 기념하며, 학부생들에게 장학금을 수여하고 전체 동문간의 network을 구축한다.', 'https://path.ssu.ac.kr/ptfol/imng/icmpNsbjtPgm/findIcmpNsbjtPgmInfo.do?encSddpbSeq=a37bbf0fb0b81d221d74de34b97f4db4', NOW()),

-- 8. 2025 동계 금융학부 성공취업캠프
('prg_1764851355515', '2025 동계 금융학부 성공취업캠프', '2025 동계 금융학부 성공취업캠프',
 'prg_3', '금융학부', '대면',
 '2025-12-01 00:00:00', '2025-12-19 23:59:00', '2026-02-27 09:00:00', '2026-02-28 18:00:00',
 '일산 동양인재개발원', '금융학부 1~4학년생', 20,
 '본 프로그램은 취업 전략에 대한 체계적 소개를 통해 취업준비에 대한 필요성을 고취시키고, 취업시장에서 개별 학생들의 취업경쟁력을 강화하는 것을 목표로 함', 'https://path.ssu.ac.kr/ptfol/imng/icmpNsbjtPgm/findIcmpNsbjtPgmInfo.do?encSddpbSeq=56a22a7a2eb9be57ecdbfb6e0ed08192', NOW()),

-- 9. 글로벌 리더십 프로그램(캐나다어학연수_동계)
('prg_1764851362779', '글로벌 리더십 프로그램(캐나다어학연수_동계)', '글로벌 리더십 프로그램(캐나다어학연수_동계)',
 'prg_11', '금융경제학과', '대면',
 '2025-12-01 16:00:00', '2025-12-10 23:00:00', '2026-01-16 00:00:00', '2026-02-14 00:00:00',
 '캐나다 밴쿠버 Global College', '숭실대학교 재학 중인 2학년, 3학년, 4학년 학생', 6,
 '글로벌 리더십 프로그램(캐나다어학연수_동계) 비교과 신청 상세 정보 테이블 입니다.', 'https://path.ssu.ac.kr/ptfol/imng/icmpNsbjtPgm/findIcmpNsbjtPgmInfo.do?encSddpbSeq=27294516e244807b6f85294b822b0477', NOW()),

-- 10. 25학년도 겨울방학 맞춤형 심리검사 프로그램
('prg_1764851372897', '25학년도 겨울방학 맞춤형 심리검사 프로그램', '25학년도 겨울방학 맞춤형 심리검사 프로그램',
 'prg_1', '상담팀', '대면',
 '2025-12-03 09:00:00', '2025-12-24 17:00:00', '2025-12-03 09:00:00', '2026-01-23 17:00:00',
 '숭실대 상담센터', '숭실대학교 학생 (재학, 휴학 가능)', 80,
 '성격, 진로, 대인관계, 학습 등 다양한 주제의 검사를 실시하고 1:1 또는 집단 활동을 통해 자기 이해를 높이는 프로그램임.', 'https://path.ssu.ac.kr/ptfol/imng/icmpNsbjtPgm/findIcmpNsbjtPgmInfo.do?encSddpbSeq=9db227791db3cfac574d04f371ddd46f', NOW());
